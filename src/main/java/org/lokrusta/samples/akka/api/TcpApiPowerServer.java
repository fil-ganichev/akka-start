...
public class TcpApiPowerServer extends TcpPointBase {


    public TcpApiPowerServer(ObjectMapper objectMapper) {
        super(objectMapper);
    }
    ...
    public static void main(String args[]) {
        ...
        TcpApiPowerServer tcpApiServer = new TcpApiPowerServer(objectMapper);
